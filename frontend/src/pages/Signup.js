              ...
              <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl border border-[#163d64]/10 p-8 shadow-xl">
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div className="text-center space-y-2">
                    <h2 className="text-2xl font-bold text-[#163d64]">Create Account</h2>
                    <p className="text-[#163d64]/70 text-sm">Join us to get started</p>
                  </div>
                  ...
                  <div className="text-center text-sm text-[#163d64]/70">
                    ...
                    <Link to="/login" className="text-[#163d64] hover:text-[#fa4516] transition-colors duration-300">
                      Sign in
                    </Link>
                  </div>
                </form>
